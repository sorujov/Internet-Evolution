...
```{r cis-comparison-plot, fig.cap="MDB ölkələrində internet sürətlərinin müqayisəsi (2019-2025)"}
...
```{r growth-comparison-plot, fig.cap="MDB ölkələrində internet sürət artımının müqayisəsi"}
