...
```{r cellular-trend-plot, fig.cap="Azərbaycan mobil internet sürətinin dinamikası"}
...
```{r cellular-statistics, tab.cap="Mobil internet trend statistikası"}
...
if (is_word) {
  ...
  knitr::kable(cellular_trend_stats,
...
```{r fixed-vs-cellular, fig.cap="Sabit və mobil internet sürətlərinin müqayisəsi"}
